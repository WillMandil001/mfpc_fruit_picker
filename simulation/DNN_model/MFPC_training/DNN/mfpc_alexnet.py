...
################################## Hyper Parameters ##################################################################
data_set_dir = '/MFPC/datasets/data_set_003'
no_of_cameras = 8 + 1
data_set_length = 165
...
for camera in range(1, no_of_cameras):
    robot_positions = pd.read_csv(data_set_dir + '/robot_pos/data_set_' + str(0) + '_robot_data_store_position.csv', header=None)
    robot_velocitys = pd.read_csv(data_set_dir + '/robot_vel/data_set_' + str(0) + '_robot_data_store_velocity.csv', header=None)
    for i in range(1, data_set_length):
        robot_positions = pd.concat([robot_positions, pd.read_csv(data_set_dir + '/robot_pos/data_set_' + str(i) + '_robot_data_store_position.csv', header=None)])
        robot_velocitys = pd.concat([robot_velocitys, pd.read_csv(data_set_dir + '/robot_vel/data_set_' + str(i) + '_robot_data_store_velocity.csv', header=None)])
    if camera == 1:
...
strawberry_1 = pd.read_csv(data_set_dir + '/straw_1/data_set_' + str(0) + '_strawberry_data_store_1.csv', delimiter=',', error_bad_lines=False,  header=None)
strawberry_2 = pd.read_csv(data_set_dir + '/straw_2/data_set_' + str(0) + '_strawberry_data_store_2.csv', delimiter=',', error_bad_lines=False, header=None)
strawberry_3 = pd.read_csv(data_set_dir + '/straw_3/data_set_' + str(0) + '_strawberry_data_store_3.csv', delimiter=',', error_bad_lines=False, header=None)
strawberry_4 = pd.read_csv(data_set_dir + '/straw_4/data_set_' + str(0) + '_strawberry_data_store_4.csv', delimiter=',', error_bad_lines=False, header=None)
strawberry_5 = pd.read_csv(data_set_dir + '/straw_5/data_set_' + str(0) + '_strawberry_data_store_5.csv', delimiter=',', error_bad_lines=False, header=None)
...
for i in range(1, data_set_length):
    strawberry_cluster_state = pd.read_csv(data_set_dir + '/straw_1/data_set_' + str(i) + '_strawberry_data_store_1.csv', delimiter=',', error_bad_lines=False, header=None)
    strawberry_2 = pd.read_csv(data_set_dir + '/straw_2/data_set_' + str(i) + '_strawberry_data_store_2.csv', delimiter=',', error_bad_lines=False, header=None)
    strawberry_3 = pd.read_csv(data_set_dir + '/straw_3/data_set_' + str(i) + '_strawberry_data_store_3.csv', delimiter=',', error_bad_lines=False, header=None)
    strawberry_4 = pd.read_csv(data_set_dir + '/straw_4/data_set_' + str(i) + '_strawberry_data_store_4.csv', delimiter=',', error_bad_lines=False, header=None)
    strawberry_5 = pd.read_csv(data_set_dir + '/straw_5/data_set_' + str(i) + '_strawberry_data_store_5.csv', delimiter=',', error_bad_lines=False, header=None)
    counter = 0
...
for camera in range(1, no_of_cameras):
    ...
    for i in range(0, data_set_length):
        for j in range(0, 50):
            im_frame = cv2.imread(data_set_dir + '/camera_' + str(camera) + '/rgb/sample_' + str(i) + '/time_step_' + str(j) + '.png')
...
################## Crate MODEL FOR RNN LATER ##################
intermediate_layer_model = leras.model.Model(inputs=model.input, outputs=dense_5)
...
##################################### save Model ###########################################################################
model.save('/MFPC/AlexNet_DNN.h5')
intermediate_layer_model.save('/MFPC/AlexNet_DNN_intermediate_layer.h5')
