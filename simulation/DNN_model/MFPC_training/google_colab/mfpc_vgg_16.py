...
Original file is located at
    https://colab.research.google.com/drive/1yccuPmMlSStX2ErIxDhLsLrkPrZamZTH
"""
...
vgg19_model = keras.models.Model(inputs=[new_model.input, robot_pose_input_layer, robot_vel_input_layer] , outputs=output_layer)
...
vgg19_model.compile(optimizer='adam',loss='mean_absolute_error', metrics=['mse','accuracy'])
	...
	history = vgg19_model.fit([train_images, robot_pose_train_input, robot_vel_train_input], robot_state_train_label, callbacks=[monitor], batch_size=20, validation_split=0.2, epochs=15)
	# score = vgg19_model.evaluate([test_images, robot_pose_test_input, robot_vel_test_input] , robot_state_test_label)

predict_AlexNet_dense = vgg19_model.predict([test_images, robot_pose_test_input, robot_vel_test_input])
...
vgg19_model.summary()
	vgg19_model.save('/content/drive/My Drive/Masters Year/data_mfpc/VGG_16_1000_leakyrelu_03.h5')
